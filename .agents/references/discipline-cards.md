...
- **File:** `.agents/references/discipline-cards.md`
- **Schema parallel:** `.agents/references/journal-profiles.md` (per-journal) and `.agents/references/audit-pet-peeves.md` (living-catalogue format).
