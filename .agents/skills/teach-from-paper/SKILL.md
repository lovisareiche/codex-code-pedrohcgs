...
- `/create-lecture` — consumes the Phase 2 slide skeleton to draft the actual Beamer deck. See [`.agents/skills/create-lecture/SKILL.md`](../create-lecture/SKILL.md).
- `/review-paper` — referee the paper's correctness *before* teaching it if you're unsure the result holds. See [`.agents/skills/review-paper/SKILL.md`](../review-paper/SKILL.md).
- `/lit-review` — for situating the paper among many, rather than teaching one deeply. See [`.agents/skills/lit-review/SKILL.md`](../lit-review/SKILL.md).
