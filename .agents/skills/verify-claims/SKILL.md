...
Fact-check a draft using the **Post-Flight Verification protocol** ([`.agents/rules/post-flight-verification.md`](../../rules/post-flight-verification.md)).
...
- `claim-verifier` agent file exists at `.agents/agents/claim-verifier.md`
...
- [`.agents/agents/claim-verifier.md`](../../agents/claim-verifier.md) — the forked verifier.
- [`.agents/rules/post-flight-verification.md`](../../rules/post-flight-verification.md) — the protocol.
