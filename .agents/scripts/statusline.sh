#!/usr/bin/env bash
# Codex status line: shows permission mode, model, and git branch.
#
# Codex pipes a JSON session snapshot to stdin. Relevant keys:
...
pct_file="$HOME/.agents/sessions/${hash}/context-pct.txt"
