...
Inputs to read:
- `.agents/rules/knowledge-base-template.md` — notation registry, narrative arc, applications
- `.agents/rules/content-invariants.md` — INV-1..INV-8 govern slide content
...
**First-lecture fallback (fresh fork, empty knowledge base).** If `.agents/rules/knowledge-base-template.md` still has unfilled placeholder tables (no notation registry entries, no applications, no prior lectures in `Slides/`), do NOT halt waiting for it. Instead:
...
- [`.agents/skills/translate-to-quarto/SKILL.md`](../translate-to-quarto/SKILL.md) — port the finished Beamer deck to a Quarto RevealJS mirror.
- [`.agents/skills/qa-quarto/SKILL.md`](../qa-quarto/SKILL.md) — adversarial Beamer↔Quarto parity (loop-until-dry).
- [`.agents/skills/deploy/SKILL.md`](../deploy/SKILL.md) — render + publish the lecture to GitHub Pages.
- [`.agents/skills/scaffold-exercises/SKILL.md`](../scaffold-exercises/SKILL.md) — problem sets + solutions to accompany the lecture.
