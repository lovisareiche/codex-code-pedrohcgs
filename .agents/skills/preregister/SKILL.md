...
- `.agents/references/discipline-cards.md` — field defaults that drive `--style` selection.
- `.agents/rules/replication-protocol.md` — preregistration is the *forward* commitment; replication-protocol is the *backward* contract.
