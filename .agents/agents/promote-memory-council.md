...
- The lesson is codified in a rule file (`.agents/rules/*.md`).
...
**Your question:** Does the entry follow the schema in [`.agents/rules/meta-governance.md`](../rules/meta-governance.md)?
