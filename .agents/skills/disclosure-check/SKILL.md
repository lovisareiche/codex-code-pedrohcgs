...
1. Read [`.agents/rules/confidential-data.md`](../../rules/confidential-data.md) for the project's restricted-data handling contract and the rule-profile placeholder.
...
- [`.agents/rules/confidential-data.md`](../../rules/confidential-data.md) — restricted-data handling contract + the provider-rule profiles this skill loads.
- [`.agents/rules/replication-protocol.md`](../../rules/replication-protocol.md) — for restricted-data papers the replication package ships code + access path, not the microdata; screen every released output first.
...
- [`.agents/skills/data-analysis/SKILL.md`](../data-analysis/SKILL.md), [`.agents/skills/stata-replication/SKILL.md`](../stata-replication/SKILL.md) — produce the R / Stata / Python outputs this skill screens.
