...
- [`.agents/rules/tikz-prevention.md`](../../rules/tikz-prevention.md) — the P1–P6 authoring rules.
- [`.agents/rules/tikz-measurement.md`](../../rules/tikz-measurement.md) — the six-pass protocol with formulas the reviewer cites.
- [`.agents/rules/tikz-visual-quality.md`](../../rules/tikz-visual-quality.md) — general visual standards.
