...
→ [`.agents/rules/model-routing.md`](../rules/model-routing.md).
...
→ [`.agents/rules/orchestrator-protocol.md`](../rules/orchestrator-protocol.md).
...
the execution shape.
→ [`.agents/rules/simulation-conventions.md`](../rules/simulation-conventions.md).
...
→ [`.agents/rules/issue-ledger.md`](../rules/issue-ledger.md), [`.agents/rules/progress-reports.md`](../rules/progress-reports.md).
...
→ [`.agents/skills/promote-memory/SKILL.md`](../skills/promote-memory/SKILL.md).
...
a minimal `.agents/` in the governed repo. And every rule shared across repos carries a
...
→ [`.agents/references/model-versions.md`](model-versions.md) is this template's worked example.
...
→ [`.agents/rules/progress-reports.md`](../rules/progress-reports.md).
...
*Mechanised:* [`.agents/hooks/git-guardrails.py`](../hooks/git-guardrails.py) refuses the
...
→ [`.agents/rules/orchestrator-protocol.md`](../rules/orchestrator-protocol.md) — the screening
...
- [`.agents/rules/repo-hygiene.md`](../rules/repo-hygiene.md) — scratch must not become main
