...
- **Do NOT treat this phrase as commit authorization.** Commits require an explicit `/commit` or unambiguous request — see [`.agents/skills/commit/SKILL.md`](../skills/commit/SKILL.md).

## Cross-references

- [`.agents/references/orchestration-schemas.md`](../references/orchestration-schemas.md) — FINDING / SCORECARD / RUN_CONFIG / hallucination-gate contracts.
- [`.agents/references/agent-fleet.md`](../references/agent-fleet.md) — the reviewer fleet + model tiers.
- [`.agents/rules/plan-first-workflow.md`](plan-first-workflow.md) — when to enter plan mode before invoking a skill.
- [`.agents/rules/quality-gates.md`](quality-gates.md) — threshold definitions + the pre-commit hook.
- [`.agents/rules/post-flight-verification.md`](post-flight-verification.md) — the forked-verifier mechanism the hallucination gate reuses.
- [`.agents/rules/cross-artifact-review.md`](cross-artifact-review.md) — paper ↔ code dependency-graph pattern.
