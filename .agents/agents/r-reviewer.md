...
2. **Read `.agents/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `.agents/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.agents/rules/r-code-conventions.md` for project-specific bugs.
