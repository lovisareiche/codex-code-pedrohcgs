...
- [`.agents/rules/replication-protocol.md`](../rules/replication-protocol.md) — what the reproducibility routine checks.
- [`.agents/rules/confidential-data.md`](../rules/confidential-data.md) — why unattended runs stay human-gated near restricted data.
