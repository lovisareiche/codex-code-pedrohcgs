...
| **The working tree** (`Slides/`, `Quarto/`, `scripts/`, `.agents/`) | the approach you chose and would defend | yes |
...
- [`.agents/rules/exploration-folder-protocol.md`](exploration-folder-protocol.md) — how `explorations/` is structured
- [`.agents/rules/meta-governance.md`](meta-governance.md) — what is committed vs local
