...
Full elaboration and examples: [`.agents/references/prompt-formatting-core.md`](../references/prompt-formatting-core.md).
...
- [`.agents/references/prompt-formatting-core.md`](../references/prompt-formatting-core.md) — the six-section elaboration.
- [`.agents/skills/interview-me/SKILL.md`](../skills/interview-me/SKILL.md) — multi-turn specification (the surviving, heavier sibling).
- [`.agents/rules/plan-first-workflow.md`](plan-first-workflow.md) — for non-trivial tasks, shaping feeds the plan.
