...
- **Follow R code conventions** in `.agents/rules/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.agents/rules/`)
...
- `.agents/rules/r-code-conventions.md` — [one-line summary of most relevant rule]
- `.agents/rules/content-invariants.md` — [INV-9, INV-10, INV-11, INV-12 applicable]
