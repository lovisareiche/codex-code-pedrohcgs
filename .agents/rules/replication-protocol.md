...
Codex's **native auto memory** is on by default and is machine-local
(`~/.agents/projects/<project>/memory/`). It can shape a session invisibly to anyone
