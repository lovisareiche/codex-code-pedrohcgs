...
- [`.agents/rules/r-package-conventions.md`](../rules/r-package-conventions.md) · [`.agents/rules/stata-code-conventions.md`](../rules/stata-code-conventions.md) — the language-specific standards this genre sits on top of
